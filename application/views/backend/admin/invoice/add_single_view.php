    ...
    <div class="row d-print-none">
            ...
            <div class="card">
                <div class="card-body py-2">
                    <h4 class="page-title d-inline-block">
                        <i class="mdi mdi-calendar-today title_icon"></i> <?php echo get_phrase('add_single_invoice'); ?>
                    </h4>
        <!--PAYMENT HISTORY-->
        ...
        <!--STUDENT FEE MANAGER BUTTON-->
        <a href="<?php echo site_url('superadmin/invoice');?>" class="btn btn-primary btn-rounded alignToTitle float-end my-1" style="margin-right: 10px;">
...
var showAllStudents = function() {
    ...
    if(class_id != "" && section_id!= ""){
        $.ajax({
            url: '<?php echo route('invoice/filter/') ?>'+class_id+'/'+section_id,
            success: function(response){
